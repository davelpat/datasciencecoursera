...
Prior to 1996, there was no standard classification of storm types. Effective beginnning in 1996, storm events were grouped into 48 standard event types. Prior to that, the storm data was both sparse and inconsistent. In addition, due to inflation, the value of money prior to 1996 in comparison to today was significantly great enough to potentially skew the data. For these reasons, we will only work with the last 15 years of the dataset. This still leaves about two thirds of the storm events in the dataset.
...
This still leaves us with nearly two thirds of a million storm events, many of which have no impact on the questions we are looking to answer. The following code block corrects the data types and filters out storm events that were reported to have no financial or health impact. This eliminates more than two thirds of the storm events in the 15 year period, but still leaves a bit over 200,000 storm events, all of which have a bearing on our two questions.
